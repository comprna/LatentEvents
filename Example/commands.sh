...
#Outputs : 3Tissues_3cl_Example.DocTopic.tab 3Tissues_3cl_Example.TopicTerm.tab 3Tissues_3cl_Example.top5000Events.txt 
...
#Output : StructurePlot_Example.pdf
...
#Outputs : SpecificityProbabilityPlot_Example_cl3.pdf SpecificityProbabilityPlot_Example_cl3.pdf SpecificityProbabilityPlot_Example_cl3.pdf
